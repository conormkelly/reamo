...
pub const MockBackend = struct {
    ...
    pub const getTakeColor = tracks.TracksMethods.getTakeColor;
    pub const setTakeColor = tracks.TracksMethods.setTakeColor;
    ...
    // FX management
    pub const trackFxAddByName = tracks.TracksMethods.trackFxAddByName;
    ...
    pub const enumInstalledFX = project.ProjectMethods.enumInstalledFX;
