/**
 * ContextRailTab - Individual tab button for vertical context rail
 *
 * Features:
 * - 56x44px touch target (fits 72px rail with padding)
...
export interface ContextRailTabProps {
...
export function ContextRailTab({
  icon: Icon,
  label,
  isActive,
  badge,
