 ...
 * - sends: (future) Gold fader for send levels
 */
export function MixerStrip({
  trackIndex,
  mode,
  faderHeight: baseFaderHeight = 180,
  showDbLabel = true,
  className = '',
  ...
  // Mode-based fader heights
  // Volume mode: max height, Mix mode: shorter to fit pan + rec arm
  const faderHeight = mode === 'volume' ? baseFaderHeight : baseFaderHeight - 50;
