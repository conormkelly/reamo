...
export const tokenToIcons: Record<string, string[]> = {
  ...
  "analyse": ["Activity","Search","ChartBar"],
  ...
  "colour": ["Palette","Paintbrush","Circle"],
  "comp": ["Layers","Combine","GitMerge"],
  ...
  "dialogue": ["MessageSquare","MessageCircle","AppWindow"],
  ...
  "maximise": ["Maximize","Maximize2","Expand"],
  ...
  "normalise": ["TrendingUp","Maximize2","Activity"],
  ...
  "organise": ["LayoutList","Layers","Group"],
  ...
  "programme": ["Code","FileText","Terminal"],
